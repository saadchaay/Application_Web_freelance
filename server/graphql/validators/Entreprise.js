...
validate_addEntreprise = async({Email, Denomination, StatueJuridique, DateCreation, Username, Password}) =>{
    const errors = {};
    ...
    if(Denomination.trim() ===''){
        errors.Denomination = "la denomination ne peut pas etre vide";
    }
    
    if(StatueJuridique.trim() ===''){
        errors.StatueJuridique = "StatueJuridique ne peut pas etre vide";
    }
    
    if(DateCreation.trim() ===''){
        errors.DateCreation = "la date de naissance ne peut pas etre vide";
    }
...
module.exports = validate_addEntreprise;